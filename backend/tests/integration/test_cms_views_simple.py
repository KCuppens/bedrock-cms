...
class PagesViewSetBasicTestCase(APITestCase):
    ...
    def test_get_by_path_success(self):
        ...
        response = self.client.get('/api/v1/cms/api/pages/get_by_path/', {
            'path': '/published-page/',
            'locale': 'en'
        })
    ...
    def test_children_endpoint(self):
        ...
        response = self.client.get(f'/api/v1/cms/api/pages/{self.published_page.id}/children/')
    ...
    def test_update_page_success(self):
        ...
        response = self.client.patch(
            f'/api/v1/cms/api/pages/{self.draft_page.id}/',
            update_data,
            format='json'
        )
