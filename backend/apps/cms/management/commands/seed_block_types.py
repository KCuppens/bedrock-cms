                ...
                'schema': {
                    ...
                    'properties': {
                        ...
                        'options': {
                            ...
                            'properties': {
                                'show_toc': {'type': 'boolean', 'title': 'Show Table of Contents'},
                                'show_author': {'type': 'boolean', 'title': 'Show Author'},
                                'show_dates': {'type': 'boolean', 'title': 'Show Dates'},
                                'show_share': {'type': 'boolean', 'title': 'Show Share'},
                                'show_reading_time': {'type': 'boolean', 'title': 'Show Reading Time'}
                            }
                        }
                    }
                }
        ...
        with transaction.atomic():
            for block_data in default_block_types:
                ...
                if created:
                    ...
                    self.stdout.write(
                        self.style.WARNING(f'Block type already exists: {block_type.label}')
                    )
