...
class RedirectMiddleware(MiddlewareMixin):
    ...
    def _find_matching_redirect(self, path):
        ...
        for redirect in active_redirects:
            ...
            if not path_without_query.endswith('/') and redirect.from_path == path_without_query + '/':
                return redirect
            if path_without_query.endswith('/') and path_without_query != '/' and redirect.from_path == path_without_query.rstrip('/'):
                return redirect
