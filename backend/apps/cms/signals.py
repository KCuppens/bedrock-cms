...
def create_page_revision(sender, instance, created, **kwargs):
    ...
    try:
        ...
        should_create = (
            is_published or 
            created or
            (user and PageRevision.should_create_autosave(instance, user))
        )
    ...
    if instance.pk:
        try:
            ...
            was_published = (
                ...
                old_instance.published_at and
                old_instance.published_at <= timezone.now()
            )
