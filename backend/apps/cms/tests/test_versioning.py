...
class VersioningAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        permissions = Permission.objects.filter(
            ...
            codename__in=['change_page', 'add_page', 'delete_page', 'view_page', 'publish_page']
        )
    ...
    def test_diff_current(self):
        ...
        response = self.client.get(f'/api/v1/cms/api/revisions/{self.revision1.id}/diff_current/')
