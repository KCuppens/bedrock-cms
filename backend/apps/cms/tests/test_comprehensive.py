...
from apps.cms.versioning import VersionManager, create_page_version, revert_page_to_version
...
class CMSVersioningTests(TestCase):
    ...
    def test_version_manager(self):
        ...
        try:
            manager = VersionManager(self.page)
...
class CMSSecurityTests(TestCase):
    ...
    def test_page_security_manager(self):
        ...
        try:
            security_manager = PageSecurityManager()
    ...
    def test_page_with_blocks(self):
        ...
        try:
            text_block = Block.objects.create(
                page=page,
                type='text',
                content={'text': 'Test block content'},
                order=1
            )
            ...
            pass  # Block model may not exist
