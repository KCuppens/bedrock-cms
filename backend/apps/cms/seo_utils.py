...
def get_best_matching_seo_default(path: str, locale: Locale) -> Optional[Dict[str, Any]]:
...
def resolve_seo(page: Page) -> Dict[str, Any]:
    ...
    try:
        ...
        global_seo = {
            ...
            'jsonld': seo_settings.jsonld_default.copy() if seo_settings.jsonld_default else [],
        }
...
def generate_hreflang_alternates(page: Page, base_url: Optional[str] = None) -> List[Dict[str, str]]:
