...
def test_pages_view_specific_lines():
    ...
    try:
        ...
        try:
            ...
            with patch.object(viewset, 'get_serializer', return_value=mock_serializer):
                with patch('apps.cms.views.pages.Page.objects') as mock_page:
                    mock_page.select_related.return_value.get.return_value = mock_instance
        ...
        try:
            ...
            with patch('apps.cms.views.pages.timezone') as mock_timezone:
                ...
                with patch('apps.cms.views.pages.PageReadSerializer') as mock_serializer:
...
def test_management_commands():
    ...
    try:
        ...
        from apps.cms.management.commands import block_new, publish_scheduled, rebuild_paths, seed_site
