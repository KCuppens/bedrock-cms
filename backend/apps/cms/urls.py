...
urlpatterns = [
    ...
    path('blocks/<str:block_type>/schema/', BlockSchemaView.as_view(), name='block-schema'),
    path('navigation/', NavigationView.as_view(), name='navigation'),
    path('footer/', FooterView.as_view(), name='footer'),
    path('site-settings/', SiteSettingsView.as_view(), name='site-settings'),
    path('pages/<int:page_id>/revisions/', MockRevisionsView.as_view(), name='page-revisions'),
