...
class BlockTypeViewSet(viewsets.ModelViewSet):
    ...
    def duplicate(self, request, pk=None):
        ...
        duplicate_data = {
            ...
            'default_props': original.default_props.copy() if original.default_props else {},
    ...
    def dashboard_data(self, request):
        ...
        for block_type in block_types_data:
            ...
            if block_obj:
                block_type['created_by_name'] = block_obj.created_by.get_full_name() if block_obj.created_by else None
                block_type['updated_by_name'] = block_obj.updated_by.get_full_name() if block_obj.updated_by else None
