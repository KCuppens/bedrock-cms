...
class BlockTypeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BlockType
        fields = [
            'id', 'type', 'component', 'label', 'description', 'category', 
            'category_display', 'icon', 'is_active', 'preload', 'editing_mode',
            'schema', 'default_props', 'created_at', 'updated_at', 
    ...
    def validate_schema(self, value):
        ...
        if 'type' in value and value['type'] not in ['object', 'array', 'string', 'number', 'boolean']:
    ...
    def validate_default_props(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError("Default props must be a valid JSON object")
        return value
...
class BlockTypeListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'type', 'component', 'label', 'description', 'category',
            'category_display', 'icon', 'is_active', 'preload', 'updated_at'
        ]
...
class BlockTypeCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'icon', 'is_active', 'preload', 'editing_mode', 'schema', 'default_props'
        ]
...
class BlockTypeUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BlockType
        fields = [
            'component', 'label', 'description', 'category', 'icon', 
            'is_active', 'preload', 'editing_mode', 'schema', 'default_props'
        ]
