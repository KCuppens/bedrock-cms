...
class Category(models.Model):
    ...
    color: models.CharField = models.CharField(max_length=7, default='#6B7280')  # Hex color
    icon: models.CharField = models.CharField(max_length=50, blank=True)  # Icon name/class
...
class Collection(models.Model):
    ...
    # Relations
    categories: models.ManyToManyField = models.ManyToManyField(Category, blank=True, related_name='collections')
    tags: models.ManyToManyField = models.ManyToManyField(Tag, blank=True, related_name='collections')
