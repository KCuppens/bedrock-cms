...
def calculate_session_duration(session_id: str, end_time: datetime = None) -> int:
    ...
    try:
        session_views = PageView.objects.filter(
...
def is_bot_user_agent(user_agent_string: str) -> bool:
    ...
    """
    bot_patterns = [
        r'bot', r'crawl', r'spider', r'scraper', r'search',
        r'facebook', r'twitter', r'linkedin', r'google',
        r'bing', r'yahoo', r'duckduckgo', r'yandex',
        r'curl', r'wget', r'python', r'requests',
        r'monitoring', r'uptime', r'pingdom', r'datadog'
    ]
