...
def test_accounts_auth_backends():
    ...
    try:
        ...
        try:
            ...
            try:
                mock_request = Mock()
                result = backend.authenticate(mock_request, email='test@example.com', password='test123')
            except:
                pass
...
def test_accounts_auth_views():
    ...
    try:
        from apps.accounts.auth_views import CustomLoginView, CustomLogoutView, CustomPasswordResetView
