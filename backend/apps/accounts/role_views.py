...
class RoleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Group
        fields = ['id', 'name', 'permissions', 'user_count', 'locale_scopes', 'locale_scope_ids']
...
class UserInviteSerializer(serializers.Serializer):
    ...
    role = serializers.CharField(required=False)  # Single role name for backward compatibility
...
class UserManagementViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(summary="Invite new user or resend invitation", tags=["User Management"])
    ...
    def invite(self, request):
        ...
        role = serializer.validated_data.get('role')  # Single role name (backward compatibility)
...
@extend_schema_view(
    ...
    retrieve=extend_schema(summary="Get permission details", tags=["Permission Management"]),
)
...
def get_scopes(request):
    ...
    scopes = [
        ...
        {'id': 'category', 'name': 'Category', 'description': 'Category-specific scope'},
    ]
