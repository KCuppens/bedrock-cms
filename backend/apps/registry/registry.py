...
# Models will be imported lazily in register_core_models() to avoid
# circular imports and "Apps aren't loaded yet" errors
...
def register_model(
    model: type[models.Model], kind: str, name: Optional[str] = None, **kwargs
) -> ContentConfig:
...
def register_core_models():
    ...
    Uses lazy imports to avoid circular import issues and
    "Apps aren't loaded yet" errors during Django startup.
    """
    from django.apps import apps

    # Register CMS Page model
    try:
        ...
        # CMS app or Page model not available yet
        pass
    ...
    try:
        ...
        # Blog app or models not available yet
        pass
