...
urlpatterns = [
    ...
    # Admin endpoints
    path('admin/suggestions/', views.SearchSuggestionListCreateView.as_view(), name='suggestion-list'),
    path('admin/suggestions/<uuid:pk>/', views.SearchSuggestionDetailView.as_view(), name='suggestion-detail'),
