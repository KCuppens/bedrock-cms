...
class BlogPostListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'author_name', 'category_name', 'locale_code',
            'tags_list', 'view_count', 'featured',
...
class BlogPostDetailSerializer(serializers.ModelSerializer):
    ...
    def get_recent_revisions(self, obj):
        ...
        if hasattr(obj, '_prefetched_objects_cache') and 'revisions' in obj._prefetched_objects_cache:
