...
def test_blog_serializers():
    ...
    try:
        from apps.blog.serializers import (
            BlogPostSerializer, BlogPostListSerializer, BlogPostDetailSerializer,
        ...
        for serializer_class in serializers:
            try:
                ...
                if hasattr(serializer_class, 'validate_slug'):
                    try:
                        validated = serializer_class.validate_slug(serializer, 'test-slug')
                    except:
                        pass
                    ...
                    if hasattr(attr, '_meta'):
                        ...
                        if hasattr(attr, 'save_model'):
                            try:
                                ...
                                mock_obj = Mock()
                                mock_form = Mock()
                                admin_instance.save_model(mock_request, mock_obj, mock_form, False)
                            except:
                                pass
