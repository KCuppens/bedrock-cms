...
from apps.i18n.translation import TranslationManager, TranslationResolver, UiMessageResolver
...
class TranslationManagerTests(TestCase):
    ...
    def test_extract_field_text(self):
        ...
        expected_json = json.dumps([{'type': 'text', 'props': {'content': 'Hello'}}], ensure_ascii=False)
    ...
    def test_get_resolver(self):
        ...
        self.assertEqual(resolver.target_locale, self.locale_en)  # Falls back to default
...
class TranslationAPITests(TransactionTestCase):
    ...
    def test_get_units_for_object(self):
        ...
        response = self.client.get('/api/v1/i18n/translation-units/for_object/', {
    ...
    def test_get_translation_status(self):
        ...
        response = self.client.get('/api/v1/i18n/translation-units/status_for_object/', {
            'model_label': 'cms.page',
            'object_id': self.page.id
        })
    ...
    def test_update_translation_unit(self):
        ...
        response = self.client.patch(f'/api/v1/i18n/translation-units/{self.unit.id}/', {
            'target_text': 'Página de Prueba',
            'status': 'draft'
        })
