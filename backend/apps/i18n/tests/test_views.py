...
from apps.i18n.models import (
    Locale, UiMessage, UiMessageTranslation, TranslationUnit,
...
class LocaleViewSetTest(TestCase):
    ...
    def test_cannot_delete_default_locale(self):
...
class UiMessageViewSetTest(TestCase):
    ...
    def test_get_message_bundle(self):
        ...
        self.assertEqual(response.data['buttons.cancel'], 'Cancel')  # Falls back to default
...
class UiMessageTranslationViewSetTest(TestCase):
    ...
    def test_update_translation(self):
        ...
        url = reverse('ui-message-translations-detail', kwargs={'pk': self.translation.pk})
        data = {
    ...
    def test_get_namespaces_with_progress(self):
...
class TranslationUnitViewSetTest(TestCase):
    ...
    def test_approve_translation(self):
        ...
        url = reverse('translation-units-approve', kwargs={'pk': self.translation_unit.pk})
    ...
    def test_reject_translation(self):
        ...
        url = reverse('translation-units-reject', kwargs={'pk': self.translation_unit.pk})
        response = self.client.post(url, {'comment': 'Needs improvement'}, format='json')
    ...
    def test_get_translation_history(self):
        ...
        url = reverse('translation-units-history', kwargs={'pk': self.translation_unit.pk})
        response = self.client.get(url)
