...
def test_i18n_views():
    ...
    try:
        from apps.i18n.views import (
            LocaleViewSet, TranslationUnitViewSet, UiMessageViewSet,
...
def test_i18n_models():
    ...
    try:
        from apps.i18n.models import (
            ...
            TranslationMemory, TranslationJob
        )
...
def test_i18n_serializers():
    ...
    try:
        from apps.i18n.serializers import (
            LocaleSerializer, TranslationUnitSerializer, UiMessageSerializer,
            UiMessageTranslationSerializer, TranslationMemorySerializer
        )
            ...
            if not attr_name.startswith('_'):
                try:
                    ...
                    if callable(attr):
                        ...
                        if 'handler' in attr_name.lower() or 'receiver' in attr_name.lower():
                            try:
                                mock_sender = Mock()
                                mock_instance = Mock()
