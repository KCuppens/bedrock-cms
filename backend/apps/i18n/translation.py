...
class TranslationResolver:
    ...
    def resolve_field(self, obj, field: str, default_value: str = "") -> str:
        ...
        try:
            ...
            optional_unit = TranslationUnit.objects.filter(
                content_type=content_type, object_id=obj.pk, field=field
            ).first()

            if optional_unit is not None and optional_unit.source_text:

                return optional_unit.source_text
...
class TranslationManager:
    ...
    def bulk_create_translations(
        ...
        Args:
            translations_data: List of dicts with obj, field, source_text, target_text
