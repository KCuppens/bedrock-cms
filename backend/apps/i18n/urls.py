...
router.register(
    r"translation-units", views.TranslationUnitViewSet, basename="translation-units"
)

router.register(r"ui-messages", views.UiMessageViewSet, basename="ui-messages")

router.register(
    r"ui-message-translations",
    views.UiMessageTranslationViewSet,
    basename="ui-message-translations",
)

router.register(r"glossary", views.TranslationGlossaryViewSet, basename="glossary")

router.register(
    r"translations/queue", views.TranslationQueueViewSet, basename="translation-queue"
)

router.register(
    r"translations/history",
    views.TranslationHistoryViewSet,
    basename="translation-history",
)
...
urlpatterns = [
    ...
    path(
        "ui/messages/<str:locale_code>.json",
