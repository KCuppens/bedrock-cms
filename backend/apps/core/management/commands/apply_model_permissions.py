                ...
                try:
                    ...
                    for codename, name in permissions:
                        ...
                        if exists:
                            ...
                            if dry_run:
                                self.stdout.write(f'  → Would create: {codename} - {name}')
                            else:
            ...
            if delete_orphaned:
                ...
                if orphaned:
                    ...
                    if not dry_run:
                        for perm in orphaned:
                            perm.delete()
                        self.stdout.write(self.style.SUCCESS(f'Deleted {len(orphaned)} orphaned permissions'))
                    else:
                        self.stdout.write(f'Would delete {len(orphaned)} orphaned permissions')
                else:
