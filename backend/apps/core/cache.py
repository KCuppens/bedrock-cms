...
class CacheKeyBuilder:
    ...
    def page_key(self, locale: str, path: str, revision_id: Optional[Union[str, int]] = None) -> str:
        """
    ...
    def content_key(self, model_label: str, locale: str, slug: str, revision_id: Optional[Union[str, int]] = None) -> str:
        """
    ...
    def blog_key(self, locale: str, slug: str, post_rev: Optional[Union[str, int]] = None, 
                page_rev: Optional[Union[str, int]] = None) -> str:
        """
...
class CacheManager:
    ...
    def get_or_set(self, key: str, callable_func, timeout: Optional[int] = None, version=None):
    ...
    def invalidate_page(self, locale: str = None, path: str = None, page_id: int = None):
        """
    ...
    def invalidate_content(self, model_label: str, locale: str = None, slug: str = None, object_id: int = None):
        """
        ...
        if locale and slug:
            ...
            try:
                ...
                if config:
                    ...
                    locale_obj = getattr(obj, config.locale_field, None) if config.locale_field else None
    ...
    def invalidate_blog_post(self, locale: str = None, slug: str = None, post_id: int = None):
        """
    ...
    def invalidate_seo(self, model_label: str = None, object_id: int = None, locale: str = None):
        """
